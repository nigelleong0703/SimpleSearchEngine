...
class Searher(object):
    ...
    def searchByYearRange(self, start: int, end: int, return_all=False):
        """
        Args:
        ...
        return self.printResult(scoreDocs)


    def searchByConf(self, conf: str, return_all=False):
        """
        Args:
            start (int): start year
            end (int): end year
    ...
    def searchByKeyword(self, key:str, return_all=False):
        """
        Args:
    ...
    def searchByAuthor(self, author:str, return_all=False):
        """
        Args:
    ...
    # def multiField(self, start: int, end: int, conf: str, key:str, author:str, return_all=False):
    #     """
    #     Args:
    #         start (int): start year
    #         end (int): end year
    ...
    #     key_query = TermQuery(Term('key',str))
    #     booktitle_query = QueryParser('booktitle',self.analyzer).parse(conf)
    #     journal_query = QueryParser('journal', self.analyzer).parse(conf)
    ...
    #     title_query_parser = QueryParser('title', self.analyzer)        
    #     author_query_parser = QueryParser('author', self.analyzer)
    ...
    def multiField(self, return_all=False):
        fields = ["title", "author"]
        query_dict = {}
        boolean_query = BooleanQuery.Builder()
        for field in fields:
